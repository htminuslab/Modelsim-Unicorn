...
{		
  ...
  //uc_reg_read(uc, UC_RISCV_REG_ZERO, &xreg[0]);  
	...
	uc_reg_read(uc, UC_RISCV_REG_FP,   &xreg[9]);
	uc_reg_read(uc, UC_RISCV_REG_S1,   &xreg[10]);
	uc_reg_read(uc, UC_RISCV_REG_A0,   &xreg[11]);
	uc_reg_read(uc, UC_RISCV_REG_A1,   &xreg[12]);
	uc_reg_read(uc, UC_RISCV_REG_A2,   &xreg[13]);
	uc_reg_read(uc, UC_RISCV_REG_A3,   &xreg[14]);
	uc_reg_read(uc, UC_RISCV_REG_A4,   &xreg[15]);
	uc_reg_read(uc, UC_RISCV_REG_A5,   &xreg[16]);
	uc_reg_read(uc, UC_RISCV_REG_A6,   &xreg[17]);
	uc_reg_read(uc, UC_RISCV_REG_A7,   &xreg[18]);
	uc_reg_read(uc, UC_RISCV_REG_S2,   &xreg[19]);
	uc_reg_read(uc, UC_RISCV_REG_S3,   &xreg[20]);
	uc_reg_read(uc, UC_RISCV_REG_S4,   &xreg[21]);
	uc_reg_read(uc, UC_RISCV_REG_S5,   &xreg[22]);
	uc_reg_read(uc, UC_RISCV_REG_S6,   &xreg[23]);
	uc_reg_read(uc, UC_RISCV_REG_S7,   &xreg[24]);
	uc_reg_read(uc, UC_RISCV_REG_S8,   &xreg[25]);
	uc_reg_read(uc, UC_RISCV_REG_S9,   &xreg[26]);
	uc_reg_read(uc, UC_RISCV_REG_S10,  &xreg[27]);
	uc_reg_read(uc, UC_RISCV_REG_S11,  &xreg[28]);
	uc_reg_read(uc, UC_RISCV_REG_T3,   &xreg[29]);
	uc_reg_read(uc, UC_RISCV_REG_T4,   &xreg[30]);
	uc_reg_read(uc, UC_RISCV_REG_T5,   &xreg[31]);
	uc_reg_read(uc, UC_RISCV_REG_T6,   &xreg[32]);
